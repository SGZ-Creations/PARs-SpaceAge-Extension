...
table.insert(data.raw.character.character.animations, {
    armors = {"par-mech-armour-mk1", "par-mech-armour-mk2", "par-mech-armour-mk3", "par-mech-armour-mk4", "par-mech-armour-mk5"},
    idle_with_gun = idle_anim,
    mining_with_tool = mining_anim,
    mining_with_tool_particles_animation_positions = {10, 25},
...
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["par-mech-armour-mk1"] = #data.raw['character-corpse']['character-corpse'].pictures
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["par-mech-armour-mk2"] = #data.raw['character-corpse']['character-corpse'].pictures
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["par-mech-armour-mk3"] = #data.raw['character-corpse']['character-corpse'].pictures
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["par-mech-armour-mk4"] = #data.raw['character-corpse']['character-corpse'].pictures
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["par-mech-armour-mk5"] = #data.raw['character-corpse']['character-corpse'].pictures
