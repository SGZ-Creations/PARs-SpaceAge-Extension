...
local MechSuits = {
	{order = "baa", flight = true, drawings = {{-0.4, -2}, {0.4, 0}}, colisions= {{-0.25, -0.25}, {0.25, 0.25}}, inventory_bonus = 150, grid_width = 40, grid_height = 40, durability= SS["MechDurability_01"].value, weightvalue = SS["MechWeight_01"].value, icon = "__PARs-SpaceAge-Extension__/graphics/icons/mech-armor.png"},
	{order = "bab", flight = true, drawings = {{-0.4, -2}, {0.4, 0}}, colisions= {{-0.25, -0.25}, {0.25, 0.25}}, inventory_bonus = 300, grid_width = 60, grid_height = 60, durability= SS["MechDurability_02"].value, weightvalue = SS["MechWeight_02"].value, icon = "__PARs-SpaceAge-Extension__/graphics/icons/mech-armor.png"},
	{order = "bac", flight = true, drawings = {{-0.4, -2}, {0.4, 0}}, colisions= {{-0.25, -0.25}, {0.25, 0.25}}, inventory_bonus = 450, grid_width = 80, grid_height = 80, durability= SS["MechDurability_03"].value, weightvalue = SS["MechWeight_03"].value, icon = "__PARs-SpaceAge-Extension__/graphics/icons/mech-armor.png"},
	{order = "bad", flight = true, drawings = {{-0.4, -2}, {0.4, 0}}, colisions= {{-0.25, -0.25}, {0.25, 0.25}}, inventory_bonus = 600, grid_width = 100, grid_height = 100, durability= SS["MechDurability_04"].value, weightvalue = SS["MechWeight_04"].value, icon = "__PARs-SpaceAge-Extension__/graphics/icons/mech-armor.png"},
	{order = "bae", flight = true, drawings = {{-0.4, -2}, {0.4, 0}}, colisions= {{-0.25, -0.25}, {0.25, 0.25}}, inventory_bonus = 750, grid_width = 120, grid_height = 120, durability= SS["MechDurability_05"].value, weightvalue = SS["MechWeight_05"].value, icon = "__PARs-SpaceAge-Extension__/graphics/icons/mech-armor.png"},
}
